...
contract UniswapTrade is Fork_Test {
    ...
    function testFuzz_SwapExactETHForTokens(uint256 ethAmount) public {
        ...
        uniswapRouter02.swapExactETHForTokens{value: 0.5 ether}(nonTaxTokenAmountOut,
        path,
        users.sender,
        block.timestamp + 100
        );
    ...
    */
    function testFuzz_RevertWhen_vanillaUniV2Sell() public {
        ...
        vm.expectRevert();
        uniswapRouter02.swapTokensForExactETH(
            0.5 ether,
            requiredAmountIn,
            path,
            users.sender,
    ...
    function test_swapExactTokensForETHSupportingFeeOnTransferTokens() public {
        ...
        uint256 actualAmountIn = desiredAmountIn - (desiredAmountIn * IRushERC20Taxable(address(rushERC20)).taxBasisPoints())/10_000;
